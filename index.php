...
<div class="container mt-4">
    ...
    if (isset($_POST['proses'])) {
        ...
        if (count($input_gejala) < 3) {
            echo "<div class='alert alert-danger mt-4 text-center'>
                    <strong><i class='fas fa-times-circle'></i> Minimal pilih 3 minat/bakat untuk proses deteksi!</strong>
                  </div>";
        } else {
            $hasil = null;
            $max_cocok = 0;
            ...
            if ($hasil) {
                ...
                $jurusan = $hasil['nama_jurusan'];
                $deskripsi = $hasil['deskripsi'];
                $tingkat = round($max_persen);
                mysqli_query($koneksi, "INSERT INTO hasil_deteksi (nama, jurusan, deskripsi, tingkat_kecocokan) 
                                        VALUES ('$nama', '$jurusan', '$deskripsi', '$tingkat')");
    ...
    <form method="POST">
        <div class="mb-3">
            <label for="nama" class="form-label"><strong>Nama Anda:</strong></label>
